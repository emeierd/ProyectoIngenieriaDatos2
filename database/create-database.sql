...
GO
CREATE TABLE d_departamento (departamento_id int IDENTITY(1,1) PRIMARY KEY, dormitorios int NOT NULL, baños int NOT NULL, estacionamiento varchar(2), bodega varchar(2));
GO
CREATE TABLE f_arriendo (arriendo_id int IDENTITY(1,1) PRIMARY KEY, url varchar(255) NOT NULL UNIQUE, comuna_id int NOT NULL, valor int NOT NULL, fecha_id date NOT NULL, departamento_id int NOT NULL);
GO
